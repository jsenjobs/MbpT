...
// @RestController
@CrossOrigin
class AppErrorController2 extends AbstractErrorController {

    private static final Logger logger = Logger.getLogger(AppErrorController2.class.getName());

    private final static String ERROR_PATH = "/error";

    public AppErrorController2(ErrorAttributes errorAttributes) {
